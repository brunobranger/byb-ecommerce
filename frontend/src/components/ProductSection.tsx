...
const ProductSection: React.FC<ProductSectionProps> = ({ firstPart, secondPart, products }) => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-12 px-4">
      <section>
        ...
        >
          {products.map(prod => (
            <div key={prod.id} className="min-w-70 sm:min-w-75 md:min-w-[320px] snap-start">
